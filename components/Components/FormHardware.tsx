...
export const FormHardware: FC<Props> = ({ product }) => {
  ...
  const onSubmit = async (form: FormData) => {
    ...
    if (form._id) {
      await axios.put(`${process.env.APIP_URL}/api/makeup/${product._id}`, data)
      router.replace('/admin')

    } else {
      await axios.post(
        `${process.env.APIP_URL}/api/makeup`, data);
      router.replace(`/admin`)
    }
  }
                ...
                <div className="px-4 py-5 bg-white space-y-6 sm:p-6">
                  ...
                  <div className="grid grid-cols-6 gap-6">
                    <div className="col-span-6 sm:col-span-4">
                      ...
                      <input
                        className="mt-2 focus:ring-pink-500 focus:border-pink-500 block w-full shadow-sm sm:text-sm  rounded-md p-1 border border-gray-300"
                        type={"text"}
                        {...register('name', {
                      ...
                      />
                      <div>
                        {errors.name && <span className="text-sm text-pink-500">{errors.name.message}</span>}
                      </div>
                    </div>
                    ...
                    <div className="col-span-6 sm:col-span-2">
                      ...
                      />
                      <div>
                        {errors.brand && <span className="text-sm text-pink-500">{errors.brand.message}</span>}
                      </div>
                    </div>
                    ...
                    <div className="col-span-6 sm:col-span-3">
                      ...
                      <select
                        className="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-pink-500 focus:border-pink-500 sm:text-sm capitalize"
                        {...register('category', {
                          required: 'Este campo es requerido',
                        })}
                      ...
                      <div>
                        {errors.category && <span className="text-sm text-pink-500">{errors.category.message}</span>}
                      </div>
                    </div>
                    ...
                    <div className="col-span-6 sm:col-span-3">
                      ...
                      <div>
                        {errors.item && <span className="text-sm text-pink-500">{errors.item.message}</span>}
                      </div>
                    </div>
                    ...
                    <div className="col-span-6 sm:col-span-3">
                      ...
                      <input
                        className="mt-2 focus:ring-pink-500 focus:border-pink-500 block w-full shadow-sm sm:text-sm border border-gray-300 rounded-md p-1"
                        type='number'
                        {...register('inStock', {
                          required: 'Este campo es requerido',
                      ...
                      />
                      <div>
                        {errors.inStock && <span className="text-sm text-pink-500">{errors.inStock.message}</span>}
                      </div>
                    </div>
                    <div className="col-span-6 sm:col-span-3">
                      ...
                      />
                      <div>
                        {errors.price && <span className="text-sm text-pink-500">{errors.price.message}</span>}
                      </div>
                    </div>
                    <div className="col-span-6 sm:col-span-3">
                    ...
                    <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                      <div className="space-y-1 text-center">
                        ...
                        <div className="flex text-sm text-gray-600">
                          <label
                            htmlFor="file-upload"
                            className="relative cursor-pointer bg-white rounded-md font-medium text-pink-500 hover:text-pink-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-pink-500"
                          >
                  ...
                  <div>
                    ...
                    <div className="mt-1">
                      <textarea
                        rows={6}
                        className="shadow-sm focus:ring-pink-500 focus:border-pink-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md p-1"
                    ...
                    <div>
                      {errors.description && <span className="text-sm text-pink-500">{errors.description.message}</span>}
                    </div>
                  ...
                  <div className="grid grid-cols-6 gap-6">
                    ...
                    <div className="col-span-6 sm:col-span-3">
                      <fieldset
                      >
                        <legend className="contents text-base font-medium text-gray-900">Colores</legend>
                            ...
                            validSizes.map((data, i) => (
                              <div className="flex items-center" key={i}>
                                <input
                                  type="checkbox"
                                  value={data}
                                  className="focus:ring-pink-500 h-4 w-4 text-pink-500 border-gray-300"
                                  {...register('color', {
                                    required: {
                                      value: true,
                                ...
                                />
                                <label htmlFor="color" className="ml-3 block text-sm font-medium text-gray-700">
                                  {data}
                                </label>
                              </div>
                            ))
                      ...
                      <div>
                        {errors.color?.length === 0 && <span className="text-sm text-pink-500">seleccione al menos un color</span>}
                      </div>
                    </div>
                    ...
                    <div className="col-span-6 sm:col-span-6">
                      ...
                      />
                      <div>
                        {errors.tone && <span className="text-sm text-pink-500">{errors.tone.message}</span>}
                      </div>
                    </div>
                  </div>
                  <div className="grid grid-cols-6 gap-6">
