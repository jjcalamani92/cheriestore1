			...
			<section className="bg-white" >
				...
				<div className="max-w-2xl mx-auto py-1 px-4 sm:px-0 lg:max-w-7xl lg:py-3 lg:px-8 grid grid-cols-1 lg:gap-4 lg:grid-cols-5">
					...
					<div className="col-span-2 " >
						<div className="lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8 mt-4 lg:mt-0">
						...
						<div className="mt-4 lg:mt-0 lg:row-span-3">
							...
							{/* <form className="mt-5">
								<button
									type="submit"
									className="mt-4 w-full bg-pink-500 border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-white hover:bg-pink-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-400"
								>
									Agregar al carrito
								</button>
							</form> */}
