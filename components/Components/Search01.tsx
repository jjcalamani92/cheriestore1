                    ...
                    <div className="block px-4 sm:px-6">
                      ...
                      <div
                        ...
                        <div className="pt-2 relative  w-full text-gray-600">
                          ...
                          />
                          {/* <div>
                            {errors.search && <span className="text-sm text-pink-500">{errors.search.message}</span>}
                          </div> */}
                          <button className="focus:ring-2 focus:ring-offset-2 bg-gray-100 text-gray-600 focus:text-pink-700 focus:rounded-full  focus:bg-gray-100 focus:ring-pink-700 focus:outline-none absolute right-0 top-0 mt-5 mr-4">
                            <FontAwesomeIcon
