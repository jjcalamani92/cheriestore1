...
export const Register = () => {
	...
	return (
		<form
			...
			className="h-screen flex bg-gray-100 from-green-400 to-pink-900 w-full py-16 px-4"
		>
			<div className="flex flex-col items-center justify-center w-full">
				<div className="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-auto  p-10">
					...
					<div>
						...
						/>
						<div>
							{errors.username && <span className="text-sm text-pink-500">{errors.username.message}</span>}
						</div>
					</div>
					<div className="mt-6  w-full">
						...
						/>
						<div>
							{errors.email && <span className="text-sm text-pink-500">{errors.email.message}</span>}
						</div>
					</div>
					<div className="mt-6  w-full">
						...
						<div>
							{errors.password && <span className="text-sm text-pink-500">{errors.password.message}</span>}
						</div>
						{
							showError
								?
								<div className="text-sm text-pink-500 pt-4">
					...
					<div className="mt-8">
						<button
							...
							className="focus:ring-2 focus:ring-offset-2 focus:ring-pink-600 text-sm font-semibold leading-none text-white focus:outline-none bg-pink-600 border rounded hover:bg-pink-700 py-4 w-full"
						>
							Register
						</button>
					</div>
