                    ...
                    <li className="text-gray-700 pt-8">
                      <div className="flex items-center">
                        <div className="flex items-center">
                          ...
                          <p className={pathname === '/admin' ? "text-pink-500 ml-3 text-lg" : "text-gray-700 ml-3 text-lg"}>Productos</p>
                        </div>
                      ...
                      {/* {product ? (
                        <div>
                          <ul className="my-3">
                            <li className="text-sm text-pink-500 py-2 px-6">Best Sellers</li>
                            <li className="text-sm text-gray-800 hover:text-pink-500 py-2 px-6">Out of Stock</li>
                            <li className="text-sm text-gray-800 hover:text-pink-500 py-2 px-6">New Products</li>
                          </ul>
                        </div>
                      ) : (
                        ""
                  ...
                  <a>
                    <li className="text-white pt-8">
                      <div className="flex items-center">
                        ...
                        <p className={pathname === '/admin/sites' ? "text-pink-500 ml-3 text-lg" : "text-gray-700 ml-3 text-lg"}>Páginas</p>
                      </div>
                    </li>
                  </a>
                </Link>
          ...
          <div className="container px-6 justify-between h-16 flex items-center lg:items-stretch mx-auto">
            <div className="h-full flex items-center">
              ...
              <ul className="pr-12 xl:flex items-center h-full hidden">
                <li 
                  className={pathname === '/admin' ? "cursor-pointer h-full flex items-center text-sm text-pink-600 tracking-normal border-b-2 border-pink-600 " : "cursor-pointer h-full flex items-center text-sm text-gry-800 mr-10 tracking-normal"}
                  // className="cursor-pointer h-full flex items-center text-sm text-pink-600 tracking-normal border-b-2 border-pink-600" 
                  onClick={() => router.push('/admin')}>Productos</li>
                <li 
                  className={pathname === '/admin/sites' ? "cursor-pointer h-full flex items-center text-sm text-pink-600 tracking-normal border-b-2 border-pink-600 " : "cursor-pointer h-full flex items-center text-sm text-gry-800 mx-10 tracking-normal"}
              ...
              <div className="w-full h-full flex items-center">
                {/* <div className="w-full pr-12 h-full flex items-center border-r">
                  <div className="relative w-full">
                    ...
                    <input className="border border-gray-100 focus:outline-none focus:border-pink-600 w-56 rounded text-sm text-gray-500 bg-gray-100 pl-8 py-2" type="text" placeholder="Search" />
                  </div>
                </div> */}
                  ...
                  <div aria-haspopup="true" className="cursor-pointer w-full flex items-center justify-end relative" onClick={() => setProfile(!profile)}>
                    {/* {profile ? (
                      <ul className="p-2 w-40 border-r bg-white absolute rounded z-40 left-0 shadow mt-64 ">
                        <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-2 hover:text-pink-600 focus:text-pink-600 focus:outline-none">
                          <div className="flex items-center">
                        ...
                        <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-2 py-2 hover:text-pink-600 focus:text-pink-600 focus:outline-none flex items-center">
                        ...
                        <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-2 py-2 hover:text-pink-600 flex items-center focus:text-pink-600 focus:outline-none">
            ...
            <div className="visible xl:hidden flex items-center relative">
              <ul className="p-2 w-64 border-r bg-white absolute top-0 -ml-2 rounded right-0 shadow mt-12 lg:mt-16 hidden">
                ...
                <li className="flex xl:hidden cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-2 py-2 hover:text-pink-600 focus:text-pink-600 focus:outline-none">
                  <div className="flex items-center">
                ...
                <li className="flex xl:hidden  cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-2 py-2 hover:text-pink-600 focus:text-pink-600 focus:outline-none flex items-center relative">
                  <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-help" width={20} height={20} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" />
                    <circle cx={12} cy={12} r={9} />
                    <line x1={12} y1={17} x2={12} y2="17.01" />
                ...
                <li className="flex xl:hidden cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-2 py-2 hover:text-pink-600 flex items-center focus:text-pink-600 focus:outline-none">
                  <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-settings" width={20} height={20} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" />
                    <path d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 0 0 2.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 0 0 1.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 0 0 -1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 0 0 -2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 0 0 -2.573 -1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 0 0 -1.065 -2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 0 0 1.066 -2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" />
                    <circle cx={12} cy={12} r={3} />
