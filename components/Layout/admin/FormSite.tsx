                ...
                <div className="px-4 py-5 bg-white space-y-6 sm:p-6">
                  ...
                  <div className="grid grid-cols-6 gap-6">
                    <div className="col-span-6 sm:col-span-4">
                      ...
                      />
                      <div>
                        {errors.title && <span className="text-sm text-pink-500">{errors.title.message}</span>}
                      </div>
                    </div>
                    ...
                    <div className="col-span-6 sm:col-span-2">
                      ...
                      />
                      <div>
                        {errors.domain && <span className="text-sm text-pink-500">{errors.domain.message}</span>}
                      </div>
                    </div>
                  ...
                  <div className="grid grid-cols-6 gap-6">
                    <div className="col-span-6 sm:col-span-4">
                      ...
                      />
                      <div>
                        {errors.address && <span className="text-sm text-pink-500">{errors.address.message}</span>}
                      </div>
                    </div>
                    ...
                    <div className="col-span-6 sm:col-span-2">
                      ...
                      />
                      <div>
                        {errors.numberPhone && <span className="text-sm text-pink-500">{errors.numberPhone.message}</span>}
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-6 gap-6">
                      ...
                      <div>
                        {errors.sizes?.length === 0 && <span className="text-sm text-pink-500">seleccione al menos una talla</span>}
                      </div>
                    </div> */}
                      ...
                      />
                      <div>
                        {errors.color && <span className="text-sm text-pink-500">{errors.color.message}</span>}
                      </div>
                    </div> */}
                    </div>
                    {/* <div className="grid grid-cols-6 gap-6">
