          ...
          <div>
              ...
              <div className="xl:w-full xl:mx-0 h-12 block bg-white shadow rounded">
                  <ul className="flex border-b px-5">
                      <li onClick={() => setActiveStatus(1)} className={activeStatus == 1 ? "text-sm border-pink-600 pt-3 rounded-t text-pink-600 mr-12" : "text-sm text-gray-600 py-3 flex items-center mr-12 hover:text-pink-600 cursor-pointer"}>
                          ...
                          {activeStatus == 1 && <div className="w-full h-1 bg-pink-600 rounded-t-md" />}
                      </li>
                      <li onClick={() => setActiveStatus(2)} className={activeStatus == 2 ? "text-sm border-pink-600 pt-3 rounded-t text-pink-600 mr-12" : "text-sm text-gray-600 py-3 flex items-center mr-12 hover:text-pink-600 cursor-pointer"}>
                          <div className="flex items-center mb-3">
                              <span>
                          ...
                          {activeStatus == 2 && <div className="w-full h-1 bg-pink-600 rounded-t-md" />}
                      </li>
                      <li onClick={() => setActiveStatus(3)} className={activeStatus == 3 ? "text-sm border-pink-600 pt-3 rounded-t text-pink-600 mr-12" : "text-sm text-gray-600 py-3 flex items-center mr-12 hover:text-pink-600 cursor-pointer"}>
                          <div className="flex items-center mb-3">
                              <span>
                                  <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-eye" width={16} height={16} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                      <path stroke="none" d="M0 0h24v24H0z" />
                          ...
                          {activeStatus == 3 && <div className="w-full h-1 bg-pink-600 rounded-t-md" />}
                      </li>
                  </ul>
              </div>
          </div>
