...
export const Login = () => {
	...
	return (
		...
		<div
			...
			className="h-screen flex bg-gray-100 from-green-400 to-pink-900 w-full "
		>
					...
					<form onSubmit={handleSubmit(onLoginSubmit)}>
						...
						<div className="mt-8">
							<button
								...
								className="focus:ring-2 focus:ring-offset-2 focus:ring-pink-00 text-sm font-semibold leading-none text-white focus:outline-none bg-pink-500 border rounded hover:bg-pink-600 py-4 w-full"
							>
								Login
							</button>
						</div>
