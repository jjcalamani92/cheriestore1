...
import { Category,Section, IMakeup, ISeo } from "../../../src/interfaces";
...
export const getStaticPaths: GetStaticPaths = async (ctx) => {
  const { makeupAll } = await graphQLClientP.request(SECTION , {site: `${process.env.API_SITE}`})
...
// import { Category,Section, IMakeup } from "../../../src/interfaces";
...
// 	});
//   const paths = data.makeupAll.map((data:IMakeup) => ({
