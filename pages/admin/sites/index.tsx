	...
	return (
        ...
        <div className="my-6 container px-2 mx-auto flex flex-row lg:flex-row items-center lg:items-center justify-between ">
					...
					<Link href="/admin/sites/new">
						<a  className="transition duration-150 ease-in-out hover:bg-pink-600 focus:outline-none border bg-pink-500 rounded text-white px-8 py-2 text-sm">Nueva Categoría</a>
					</Link>
				</div>
